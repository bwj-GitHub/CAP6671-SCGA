...
public class ServerGUI 
{
	...
	{	
		GameListGenerator.GenerateGames(1, ServerSettings.Instance().MapVector, ServerSettings.Instance().BotVector, ServerSettings.Instance().TournamentType, ServerSettings.Instance().GamesListFile);
		/*
		...
		if (!new File(ServerSettings.Instance().GamesListFile).exists())
		{
			...
			if (generate == JOptionPane.YES_OPTION)
			{
				...
				GameListGenerator.GenerateGames(Integer.parseInt("" + spinner.getValue()), ServerSettings.Instance().MapVector, ServerSettings.Instance().BotVector, ServerSettings.Instance().TournamentType, ServerSettings.Instance().GamesListFile);
